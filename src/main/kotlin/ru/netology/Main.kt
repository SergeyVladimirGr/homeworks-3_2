...
const val MIN_COMMISSION_VISA_MIR = 35
...
//    while (true) {
        ...
        println(commission(amountInKop, CardType.MasterCard, amountTransfersMonth = 35_000))
    }
//}
...
fun commissionVisaMir(amountInKop: Int): Int {
    ...
    val result = if (commission >= MIN_COMMISSION_VISA_MIR) commission / KOPECK else MIN_COMMISSION_VISA_MIR
    return result.toInt()
}
